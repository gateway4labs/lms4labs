<?php
   ...
   //echo $OUTPUT->header();
    ...
    $cond = array("name" => "Labmanager-Url");
     if (record_exists("lms4labs", $cond)) {
...
<div align="left">
      ...
      Labmanager_Url:      <input type="text" name="f1laburl" size="120"  maxlength="255" value="<?php  p($Laburl) ?>" /> <br><br><br>
	Labmanager_User:     <input type="text" name="f1labuser" size="40"  maxlength="255" value="<?php  p($Labuser) ?>" /> <br><br><br>
	Labmanager_Password: <input type="password" name="f1labpass" size="20"  maxlength="255" value="<?php  p($Labpass) ?>" /> <br><br><br>
	LMS_User:            <input type="text" name="f1lmsuser" size="120"  maxlength="255" value="<?php  p($Lmsuser) ?>" /> <br><br><br>
	LMS_Password:        <input type="password" name="f1lmspass" size="20"  maxlength="20" value="<?php  p($Lmspass) ?>" /> <br><br><br>
